...
const data = [
  {title: 'Dummy Booth 1', value: '1', body: 'Time: 10minutes'},
  {title: 'Dummy Booth 2', value: '2', body: 'Time: 10minutes'},
  {title: 'Dummy Booth 3', value: '3', body: 'Time: 10minutes'},
];
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: '#F5F5F5'}}>
      <ScrollView>
        <View style={styles.container}>
          ...
          <Text style={styles.header}>Available Booths Near you</Text>
          <FlatList
            ...
            ListFooterComponent={() => (
              <>
                ...
                <Text style={[styles.footext]}>
                  Confirm your emergency drop-off to {tilt} .
                </Text>
              </>
            )}
          />
...
const styles = StyleSheet.create({
  ...
  seperatorSelected: {backgroundColor: '#fff'},
  normalseperator: {
    height: 1,
    width: 315,
    backgroundColor: '#FA8832',
